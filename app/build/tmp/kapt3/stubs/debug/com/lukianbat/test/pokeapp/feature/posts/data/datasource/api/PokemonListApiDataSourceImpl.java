...
public final class PokemonListApiDataSourceImpl implements com.lukianbat.test.pokeapp.feature.posts.data.datasource.api.PokemonListApiDataSource {
    ...
    @java.lang.Override()
    public retrofit2.Call<com.lukianbat.test.pokeapp.feature.posts.domain.model.PokemonDetailNetworkDto> getPokemonDetail(@org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public retrofit2.Call<com.lukianbat.test.pokeapp.feature.posts.domain.model.PokemonsListNetworkDto> getPokemonsTop() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public retrofit2.Call<com.lukianbat.test.pokeapp.feature.posts.domain.model.PokemonsListNetworkDto> getPokemonsTopAfter(int after) {
        return null;
    }
